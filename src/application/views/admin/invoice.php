...
<form action="index.php/admin/submit_get_invoice" method="POST">
    <p>
        按时间：
        开始日期：
    ...
    <p>
        ...
        <a type="button" class="btn" target="_blank" href="index.php/export/download_admin_invoice_list">下载名单</a>
    </p>
</form>
