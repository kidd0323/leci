...
<form action="<?php echo site_url("project/submit_post_feedback/$pid"); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
	<div class="legend"><a href="<?php echo site_url("project/info/$pid"); ?>"><?php echo $project_info->title; ?></a> > 发布反馈</div>
